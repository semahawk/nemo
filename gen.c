...
struct Node *genAssignment(char *name, struct Node *val, struct Node *block)
{
  ...
  debug("gen", "assignment node <name: %s> at %p", name, new);
...
struct Node *genExpByInt(int val)
{
  ...
  debug("gen", "integer node <val: %d> at %p", val, new);
...
struct Node *genExpByFloat(float val)
{
  ...
  debug("gen", "float node <val: %f> at %p", val, new);
...
struct Node *genExpBySingleString(char *val)
{
  ...
  debug("gen", "string node <val: '%s'> at %p", val, new);
...
struct Node *genExpByName(char *name, struct Node *block)
{
  ...
  debug("gen", "identifier node <name: %s> at %p", name, new);
...
struct Node *genBinaryop(struct Node *left, struct Node *right, Binary op, struct Node *block)
{
  ...
  debug("gen", "binary operation node <op: '%s'> at %p", binarytos(op), new);
...
struct Node *genUnaryop(struct Node *left, Unary op, struct Node *currentblock)
{
  ...
  debug("gen", "unary operation node <op: '%s'> at %p", unarytos(op), new);
...
struct Node *genEmptyBlock(struct Node *parent, struct Node *funcdef)
{
  ...
  if (parent)
    debug("gen", "empty block node at %p with parent at %p", new, parent);
  else
    debug("gen", "main block node at %p", new);
...
struct Node *genStatement(struct Node *new, struct Node *toappend)
{
  ...
  debug("gen", "statement node at %p", new);
...
struct Node *genFuncDef(Type returntype, char *name, struct ArgList *args, int argcount)
{
  ...
  debug("gen", "function definiton <name: %s> at %p", name, new);
...
struct ArgList *genArgList(Type type, char *name, struct ArgList *head, int pos)
{
  ...
  debug("gen", "argument list at %p", arglist);
...
struct ParamList *genParamList(struct Node *param, struct ParamList *head, int pos)
{
  ...
  debug("gen", "parameter list at %p", new);
...
struct Node *genReturn(struct Node *expr)
{
  ...
  debug("gen", "return node at %p", new);
...
struct Node *genIter(char *type, struct Node *count, struct Node *block)
{
  ...
  debug("gen", "iter node <type: '%s'> at %p", type, new);
