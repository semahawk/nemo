...
struct infnum  infnum_and(struct infnum, struct infnum);
struct infnum  infnum_xor(struct infnum, struct infnum);
struct infnum  infnum_or(struct infnum, struct infnum);
